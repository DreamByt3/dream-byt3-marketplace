      ...
      >
        <Flex css={{ my: '$6', mb: '$6', gap: 65 }} direction="column">
          ...
          <Flex css={{ my: '$6', gap: 20 }} direction="column">
            {`Thank you for being part of our community at DreamByt3, operating as DreamByt3 ("DreamByt3", "we", "us", or "our“). Your privacy is important to us. It is DreamByt3's policy to respect your privacy and comply with any applicable law and regulation regarding any personal information we may collect about you, including across our website, qx.app, and other sites we own and operate.`}
            <br/><br/>
            ...
            <p>
              DreamByt3<br/>
              <Link href="https://twitter.com/DreamByt3" target="_blank" rel="noreferrer noopener">
                <Text color="primary">
                  @DreamByt3
                </Text>
              </Link>
